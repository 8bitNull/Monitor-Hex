...
export function ResourceHistory({rows,node,hours,metric,onMetric:setMetric}:{rows:Row[];node:Node;hours:number;metric:ResourceMetricKey;onMetric:(key:ResourceMetricKey)=>void}){
