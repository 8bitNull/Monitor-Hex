import {RefreshCw,Waves,Activity,Network} from 'lucide-react'
...
export function DetailToolbar({busy,updated,failed,tab,hours,smooth,onTab,onHours,onSmooth,onRefresh}:{busy:boolean;updated:number|null;failed:boolean;tab:HistoryTab;hours:number;smooth:boolean;onTab:(tab:HistoryTab)=>void;onHours:(hours:number)=>void;onSmooth:(value:boolean)=>void;onRefresh:()=>void}){
