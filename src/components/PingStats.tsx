...
export function PingStats({ online = true, id, probe = "auto", onOpenRoutes, count = 1, scale = 200, warn = 80, high = 160 }: { scale?:200|500; warn?:number; high?:number; count?:number; online?:boolean; id:number; probe?:string; onOpenRoutes:(route:OpenRoutes)=>void }) {
